...
class BucketMain extends Component {
  ...
  /*
  bucketList에 항목을 추가형 전체 컴포넌트에 전파될수 있도록
  메서드를 선언
  ...
  => 그러면 어떻게??
    새로운 객체를 만들고
        ...
        변경 : 기존객체에 변경된 내용만 변경하여 새로운 객체에 복사
  */
  bucket_add = b_title => {
  ...
  한개라도 state 변수가 병동되면 rendering이 발생을 할텐데

  그러지 말고
  state 변수중에 bucketList만 감시하다가
