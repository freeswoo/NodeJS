...
module.exports = function(app,config){
    ...
    */
    ...
    // 사용할수 있도록 초기화
    // 기본 limite 10, 최대 limite 50개로 설정
    app.use(paginate.middleware(10,50))

    // 한 페이지에 몇개씩 보여줄것인가를 설정한 값
    const pageLimit = 10
    ...
    router.get("/viewStation",function(req,res){
        ...
        // 전달되어 오면
        // 그 페이지번호에 pageLimite 값을 곱하여
        // 몇번째 데이터부터 읽어 올것인지를 정하는 값을 계산
        // offset == skip
        ...
        .exec(function(err,count){
            ...
            // 위애서 계산 pageLimit, offset값을 활용하여
            // 필요한 데이터만 추출한다.
            gjStation.find({})
            .limit(pageLimit)
            .skip(offset)
